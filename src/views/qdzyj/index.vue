<template>
  <div class="configurationss-box">
    ...
    <div class="configurationss-num">
      共<span class="span1">{{ weParams }}</span
      >笔订单
    </div>
    <div class="configurationss-num">
            ...
            <div class="item-msg">
              ...
              <div class="item-text-box">
                <van-cell
                  title="佣金金额"
                  value-class="vaClass"
                  v-if="item.agent_amount"
                  :value="'￥' + item.agent_amount"
                />
                <van-cell title="佣金金额" value-class="vaClass" v-if="item.amount" :value="'￥' + item.amount" />
                <van-cell title="下单时间" :value="item.create_time" />
                <van-cell title="订单类型" :value="item.order_type_name" />
                <van-cell title="订单金额" :value="item.order_amount || item.team_amount" />
                <!-- <van-cell title="所属分销员" v-if="myParams == 'qudao'" :value="item.agent_name + '/' + item.agent_tel" /> -->
                <van-cell title="所属分销员" v-if="myParams == 'qudao'">
                 <template>
  ...
  methods: {
    ...
    getdatalist() {
      getCommissionList({
        ...
        this.weParams = res.data.list.total
    ...
    getdatalists() {
      getCommission({
        ...
        this.datarows = res.data.rows
        this.orderCounts = res.data.total_amount
