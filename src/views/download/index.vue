<template>
  <div class="wrap" style="position: relative;">
    <div class="main">
      <div class="bglutu">
        <div class="top">
          <img src="../../assets/xkdimg/dkyy.png" />
          <p class="p2">抖小客</p>
          <p class="p3">完成推广任务，得佣金</p>
        </div>
      </div>

      <!-- v-if="browser.versions.android" -->
      <div @click="android()" class="bottom">
        <img src="../../assets/xkdimg/android.png" alt />
      </div>
    ...
    <div v-if="flag" class="zhez">
      <img class="right-share" src="../../assets/xkdimg/rightbg.png" alt />
    </div>
  </div>
</template>
...
import { getUrlVersion } from '@/api/user.js'
export default {
  data() {
    return {
      url: '',
...
.bglutu {
  width: 100%;
  height: 760px;
  background-image: url('../../assets/xkdimg/dxkbgb.png');
